...
$esubject = "Trabajos Destacados-Horbach Language"; 

// The email text for copies sent to you
$emailtext = "
$_POST[name] ha usado Dile a un amigo. Sus correos son $_POST[email]

Las personas a las que se les recomendo el sitio son:
...
$tsubject = "$_POST[name] le recomienda Horbach Language";
